...
### **Array**
- **Array** merupakan pengorganisasian data dan tempat penyimpanan data atau Struktur data yang digunakan untuk menyimpan sekumpulan data dalam satu tempat
...
``` 
    const cars = ['lamborgini', 'hyundai', 'mitsubhisi'];
    cars[2] = ['toyota'];
    console.log(cars)// output : ['lamborgini','hyundai','toyota']
```
...
- .length yaitu mengembalikan nilai dari jumlah panjang data suatu array
    ``` 
    let cars = ['lamborgini', 'hyundai', 'mitsubhisi'];
...
- **Array Method**  atau biasa disebut dengan built-in methods 
  - Contoh array built in method :
    ...
    ```
     let cars = ['lamborgini', 'hyundai', 'mitsubhisi'];
     cars.push('toyota')
     console.log(cars) // output:['lamborgini', 'hyundai', 'mitsubhisi','toyota']
    ```
    - .pop adalah method yang menghapus item array index terakhir
    ``` 
     let cars = ['lamborgini', 'hyundai', 'mitsubhisi'];
     cars.pop()
     console.log(cars) // output: ['lamborgini', 'hyundai']
    ```
    - .shift adalah method untuk menghapus item array pada index pertama 
    ``` 
     let cars = ['lamborgini', 'hyundai', 'mitsubhisi'];
     cars.shift()
     console.log(cars) // output: ['lamborgini', 'mitsubhisi']
    ```
    - .unshift adalah method untuk menambahkan array pada index pertama 
    ``` 
     let cars = ['lamborgini', 'hyundai', 'mitsubhisi'];
     cars.unshift('toyota')
     console.log(cars) // output:['toyota','lamborgini', 'hyundai', 'mitsubhisi']
     ```
...
- Method adalah action dari sebuah object. 
  ...
  - Saat pemanggilan properti object dapat menggunakan bracket notation
    ...
    let person = {
        name : 'Umar',
        age : 22,
        'current address': 'Tanggerang Selatan','Banten'
    }
    console.log(person['name'])
    ```
- Update object 
...
- Built in Method Regex
  ...
  - match() yaitu method yang mengembalikan nilai array dari karakter yang match
    ...
    let myRegex = /c/;
    let myName = 'Umar';
    console.log(myName.match(myRegex)); // output : [ 'c', index: 3, input: 'Umar', groups: undefined ]
    ```
   - Flags pada javascript :
     ...
     - g : untuk mencari kedalam seluruh string yang ingin dicari. Jika tidak menggunakan flags g maka sistem akan mengembalikan nilai array pertama yang ditemukan tanpa melanjutkan pencarian
      ...
      // output : [ 'c', index: 3, input: 'Umar', groups: undefined ] // output: [ 'C', 'c' ]
      ```
...
- 4 Pilar dalam OOP :
  ...
  - Inheritance adalah sebuah proses dimana sebuah kelas mewariskan properti dan method ke kelas lain atau childnya
     ```
        ...
        let pns1 = new PNS("Umar Khoirul Afif", 22, 1152000081, "Tanggerang");
...
- **Asynchronous - Fetch** merupakan cara baru dalam melakukan network request yang memanfaatkan sebuah Promise dalam penggunaanya. Karen Fetch mengembalikan sebuah Promise maka respon handling yang digunakan adalah **then** jika promise mengembalikan resolve dan **catch** jika promise mengembalikan nilai rejec
